...
class TestTransactionCreation:
    ...
    def test_create_transaction_success(self, test_user, test_category):
    ...
    def test_create_income_transaction(self, test_user, test_category):
    ...
    def test_create_transaction_missing_fields(self, test_user):
...
class TestTransactionRetrieval:
    ...
    def test_get_transaction_success(self, test_user, test_category):
    ...
    def test_get_paginated_transactions(self, test_user, test_category):
...
class TestTransactionUpdate:
    ...
    def test_update_transaction_success(self, test_user, test_category):
    ...
    def test_update_transaction_type(self, test_user, test_category):
...
class TestTransactionDeletion:
    ...
    def test_delete_transaction_success(self, test_user, test_category):
...
class TestBalanceUpdates:
    ...
    def test_balance_updates_on_transaction_creation(self, test_user, test_category):
        ...
        # Verifica balance
        balance_response = client.get(f"/balances/{test_user['id']}")
    ...
    def test_balance_updates_on_transaction_update(self, test_user, test_category):
        ...
        # Atualiza valor
        client.put(f"/transactions/{transaction_id}", json={"amount": 150.00})
    ...
    def test_balance_updates_on_transaction_deletion(self, test_user, test_category):
